...
using EstacaoDDD.Infra.Dados.Repositorio;
...
namespace EstacaoDDD.Apresentacao
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IEstacao, EstacaoRepositorio>();
            services.AddSingleton<IEstacaoApp, EstacaoApp>();
